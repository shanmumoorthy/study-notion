...
// //     const thumbnail = req.files?.thumbnailImage || req.body.thumbnail;
...
// //   thumbnailPublicId = thumbnailDetails.public_id;
// // } else if (typeof thumbnail === "string") {
// //   thumbnailUrl = thumbnail; // Direct URL when testing with raw JSON
// // }
...
//     // ✅ Parse "tag" and "instructions" properly
//     let tag = _tag;
...
//       } catch {
//         instructions = _instructions.split(",").map((i) => i.trim());
//       }
//     }

//     // ✅ Handle thumbnail (either file or direct URL)
//     const thumbnail = req.files?.thumbnailImage || req.body.thumbnail;
//     let thumbnailUrl = "";
//     let thumbnailPublicId = "";
...
//       thumbnailPublicId = thumbnailDetails.public_id;
//     } else if (typeof thumbnail === "string") {
//       thumbnailUrl = thumbnail; // Direct Cloudinary URL
//     }
      ...
      if (Object.hasOwn(updates, key)) {
        if (key === "tag" || key === "instructions") {
          try {
            ...
            course[key] = updates[key].split(",").map((t) => t.trim());
          }
        } else {
          course[key] = updates[key];
        }
